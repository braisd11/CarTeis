...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame.setGeometry(QtCore.QRect(10, 10, 733, 76))
        ...
        self.gridLayout_2.addWidget(self.txtNombre, 1, 6, 1, 3)
        self.lblFechaAlta = QtWidgets.QLabel(parent=self.frame)
        self.lblFechaAlta.setObjectName("lblFechaAlta")
        self.gridLayout_2.addWidget(self.lblFechaAlta, 0, 6, 1, 1)
